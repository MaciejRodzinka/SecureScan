...
class QRScannerService: NSObject {
    ...
    func setupScanner(in view: UIView, completion: @escaping (String?) -> Void) {
        ...
        // Create a fancy green scanning frame with animation
        ...
        // Add corners to make it look more high-tech
        let cornerLength: CGFloat = 20
        let cornerThickness: CGFloat = 5
        
        // Create the corners (top-left, top-right, bottom-left, bottom-right)
    ...
    // If you want to scan a QR code from an existing image
...
extension QRScannerService: AVCaptureMetadataOutputObjectsDelegate {
    func metadataOutput(_ output: AVCaptureMetadataOutput, didOutput metadataObjects: [AVMetadataObject], from connection: AVCaptureConnection) {
        ...
        // Check if there is at least one metadata object
        ...
        // If the found metadata is a QR code
        if metadataObj.type == AVMetadataObject.ObjectType.qr {
            ...
            // Check if we successfully got the string value
